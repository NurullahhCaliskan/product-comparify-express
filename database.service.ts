...
export let collections = {
    ...
    productPriceHistoryTodayModel : db.collection("product-price-history-today"),
    productPriceHistoryYesterdayModel : db.collection("product-price-history-yesterday"),
